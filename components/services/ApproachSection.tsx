    ...
    return (
        <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20 lg:pb-20 mx-auto">
            <div className="max-w-3xl mb-10 lg:mb-14">
                ...
                <p className="mt-1 text-black">This profound insight guides our comprehensive strategy — from meticulous research and strategic planning to the seamless execution of brand development and website or product deployment.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
                <div className="aspect-w-16 aspect-h-9 lg:aspect-none">
                    ...
                    <Image 
                        ...
                        alt="Features Image"
                        width={480}    // Define the width of the image
                        height={600}   // Define the height of the image
                        priority       // Optional: Mark as priority for optimization
                    />
                </div>
                ...
                <div>
                    ...
                    <a className="group inline-flex items-center gap-x-2 py-2 px-3 bg-black font-medium text-sm text-neutral-100 rounded-full focus:outline-none" href="#">
